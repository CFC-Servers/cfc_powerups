...
do
  ...
  local _base_0 = {
    AltFireAdjustor = function(self)
      ...
      return activeWeapon:SetNextSecondaryFire(CurTime() + altFireDelay)
    end,
    ...
    NewExplosionWatcher = function(self)
      return function(ent)
        ...
        return timer.Simple(clusterDelay, function()
          if ent.isClustered then
            return 
          end
    ...
    ApplyEffect = function(self)
      ...
      do
        ...
        _with_0:ChatPrint("You've gained " .. tostring(getConf("grenadier_duration")) .. " seconds of the Grenadier Powerup")
        return _with_0
      end
    end,
    Refresh = function(self)
      _class_0.__parent.__base.Refresh(self, self)
      timer.Start(self.durationTimer)
      return self.owner:ChatPrint("You've refreshed your duration of the Grenadier Powerup")
    end,
  ...
  _class_0 = setmetatable({
    __init = function(self, ply)
      ...
      local duration = getConf("grenadier_duration")
      self.durationTimer = "CFC_Powerups-Grenadier-" .. tostring(ply:SteamID64())

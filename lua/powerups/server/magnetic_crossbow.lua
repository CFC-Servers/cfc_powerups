...
do
  ...
  local _base_0 = {
    ...
    pointTowardsTarget = function(self, target)
      local targetOffset = Vector(0, 0, 36)
      local targetPos = target:GetPos() + targetOffset
    ...
    canTargetPlayer = function(self, ply)
      ...
      if not (ply:GetNWBool("CFC_PvP_Mode")) then
        return false
      end
    ...
    getPotentialTargets = function(self)
      ...
      local potentialTargets = ents.FindInCone(origin, normal, 300, math.cos(math.rad(35)))
...
do
  ...
  local _base_0 = {
    ...
    ApplyEffect = function(self)
      ...
      local duration = getConf("magnetic_crossbow_duration")
    ...
    Refresh = function(self)
      ...
      self.UsesRemaining = self.UsesRemaining + 10
      return self.owner:ChatPrint("You've gained " .. tostring(10) .. " extra Magnetic Crossbow Bolts (total: " .. tostring(self.UsesRemaining) .. ")")
    end,
